    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">{{ session('user') }}</span>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p>Copyright &copy; 2020-{{ date('Y') }} <a href="https://www.qcarcaretak.com">Qcarcaretak</a>. Developer <a href="https://www.facebook.com/a.aek1998/">Aekkachai Chatpanglurlurt</a>. </br>Advisor ผศ.กฤตาพร พัชระสุภา Joint Advisor อาจารย์ธนิสสรา พินิจมนตรี and ผศ.อำนาจ ทับเกิด.</br> Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
            <!-- END MAIN CONTENT-->
